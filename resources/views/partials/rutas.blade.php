<script>
    window.rutas = {
        ...
        logo: '{{url('assets_front/images/logo.png')}}',
        mastercard: "{{url('assets_front/images/mastercard.svg')}}",
        visa: "{{url('assets_front/images/visa.svg')}}",
        amex: "{{url('assets_front/images/amex.svg')}}",
        maestro: "{{url('assets_front/images/maestro.svg')}}",
        bancard: "{{url('assets_front/images/bancard.png')}}",
