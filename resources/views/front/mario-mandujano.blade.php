...
<div class="centrar">
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-4">
                <img id="btn-video-1" src="{{asset('assets_front/img/fotos/MarioMandujano/1.jpg')}}" class="btn-directors-1"/>
                <div class="nombre-video"><img src="{{asset('assets_front/img/amarillo-vertical.png')}}" /> COMPARTAMOS BANCO</div>
            </div>

            <div class="col-md-4">
                <img id="btn-video-2" src="{{asset('assets_front/img/fotos/MarioMandujano/2.jpg')}}"  class="btn-directors-2"/>
                <div class="nombre-video"><img src="{{asset('assets_front/img/amarillo-vertical.png')}}" /> Sico</div>
            </div>

            <div class="col-md-4">
                <img id="btn-video-3" src="{{asset('assets_front/img/fotos/MarioMandujano/3.jpg')}}" class="btn-directors-3"/>
                <div class="nombre-video"><img src="{{asset('assets_front/img/amarillo-vertical.png')}}" /> Lysol</div>
            </div>
        </div>
    </div>
</div>
