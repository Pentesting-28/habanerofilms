...
<div class="centrar">
    <div class="container">
        <p class="titulo">DIGITAL & CONTENT</p>
	 	<div class="row">
            <div class="col-md-4">
                <div id="hover-1" class="btn-digital-1">
            ...
            <div class="col-md-4">
                <div id="hover-2" class="btn-digital-2">
                    <table class="tabla-content">
                        <tr>
                            <td valign="middle">
                                <img src="{{asset('assets_front/img/left.png')}}" class="left" />
            ...
            <div class="col-md-4">
                <div id="hover-3" class="btn-digital-3">
                    <table class="tabla-content">
                        <tr>
                            <td valign="middle">
                                <img src="{{asset('assets_front/img/left.png')}}" class="left" />
	 	...
	 	<div class="row" style="margin-top:30px;">
            <div class="col-md-4">
                <div id="hover-4" class="btn-digital-4">
                    <table class="tabla-content">
                        <tr>
                            <td valign="middle">
                                <img src="{{asset('assets_front/img/left.png')}}" class="left" />
            ...
            <div class="col-md-4">
                <div id="hover-5" class="btn-digital-5">
                    <table class="tabla-content">
                        <tr>
                            <td valign="middle">
                                <img src="{{asset('assets_front/img/left.png')}}" class="left" />
            ...
            <div class="col-md-4">
                <div id="hover-6" class="btn-digital-6">
                    <table class="tabla-content">
                        <tr>
                            <td valign="middle">
                                <img src="{{asset('assets_front/img/left.png')}}" class="left" />
	 	...
	 	<div class="row" style="margin-top:30px;">
            <div class="col-md-4">
                <div id="hover-7" class="btn-digital-7">
                        <table class="tabla-content">
                            <tr>
                                <td valign="middle">
                                <img src="{{asset('assets_front/img/left.png')}}" class="left" />
            ...
            <div class="col-md-4">
                <div id="hover-8" class="btn-digital-8" >
                    <table class="tabla-content">
                        <tr>
                            <td valign="middle">
                            <img src="{{asset('assets_front/img/left.png')}}" class="left" />
            ...
            <div class="col-md-4">
                <div id="hover-9" class="btn-digital-9">
                    <table class="tabla-content">
                        <tr>
                            <td valign="middle">
                                <img src="{{asset('assets_front/img/left.png')}}" class="left" />
            ...
            <td valign="middle">
                <div class="head-full">
                    ...
                    <div style="position:relative;top:-22pt;margin-left:5px;">
                        ...
                        <span class="titulo-full-3">FOR THE DEAF</span>
                        <span class="titulo-full-4">BANAMEX RECIPES</span>
                        <span class="titulo-full-5">ROCK THE VOTE DÉMIAN BICHIR AND CECILIA SUÁREZ</span>
                        <span class="titulo-full-6">ÁLVARO</span>
                        <span class="titulo-full-7">VIDEO CLIP: “SIEMPRE TÚ” BY AXEL MUÑIZ AND ALEXANDRA STAN</span>
                        <span class="titulo-full-8">VIDEO CLIP: “LA BUSQUEDA” BY FOBIA</span>
                        <span class="titulo-full-9">BRANDED CONTENT: VITAMIN C</span>
                    </div>
                </div>
                <div>
                    ...
                    <p>
                        ...
                        <iframe src="https://player.vimeo.com/video/229459846/?byline=0&portrait=0&amp;autoplay=0" class="frame-videos" id="video-digital-3" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
                        <iframe src="https://player.vimeo.com/video/229463213/?byline=0&portrait=0&amp;autoplay=0" class="frame-videos" id="video-digital-4" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
                        <iframe src="https://player.vimeo.com/video/229623740/?byline=0&portrait=0&amp;autoplay=0" class="frame-videos" id="video-digital-5" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
                        <iframe src="https://player.vimeo.com/video/229467619/?byline=0&portrait=0&amp;autoplay=0" class="frame-videos" id="video-digital-6" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
                        <iframe src="https://player.vimeo.com/video/221368585/?byline=0&portrait=0&amp;autoplay=0" class="frame-videos" id="video-digital-7" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
                        <iframe src="https://player.vimeo.com/video/198448872/?byline=0&portrait=0&amp;autoplay=0" class="frame-videos" id="video-digital-8" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
                        <iframe src="https://player.vimeo.com/video/240761283/?byline=0&portrait=0&amp;autoplay=0" class="frame-videos" id="video-digital-9" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
                    </p>
                </div>
            </td>
        </tr>
