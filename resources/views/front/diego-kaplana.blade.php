...
<div class="centrar">
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-4">
                <img id="btn-video-1" src="{{asset('resources/img/fotos/DiegoKaplan/3.jpg')}}" class="btn-directors-1" />
                <div class="nombre-video"><img src="{{asset('resources/img/amarillo-vertical.png')}}" /> SUEGRO </div>
            </div>

            <div class="col-md-4">
                <img id="btn-video-2" src="{{asset('resources/img/fotos/DiegoKaplan/2.jpg')}}"  class="btn-directors-2"  />
                <div class="nombre-video"><img src="{{asset('resources/img/amarillo-vertical.png')}}" /> COCA COLA - INSULTOS </div>
            </div>

            <div class="col-md-4">
                <img id="btn-video-3" src="{{asset('resources/img/fotos/DiegoKaplan/1.jpg')}}" class="btn-directors-3"  />
                <div class="nombre-video"><img src="{{asset('resources/img/amarillo-vertical.png')}}" /> AUTO VÍA CAMIONES </div>
            </div>
        </div>
